...
original = misc.imread(os.path.join(dir_path, 'Monochrome Photo Example 2.nmp'))
marked = misc.imread(os.path.join(dir_path, 'Marked Photo Example 2.bmp'))
...
misc.imsave(os.path.join(dir_path, 'Colorized Photo Example 2.bmp'), colorizedRGB, format='bmp')
